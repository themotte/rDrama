...
def participation_stats(v):
	...
	stats = {
		...
		"removed posts (by admins)": submissions.filter(Submission.state_mod == StateMod.REMOVED).count(),
		...
		"removed comments (by admins)": comments.filter(Comment.state_mod == StateMod.REMOVED).count(),
