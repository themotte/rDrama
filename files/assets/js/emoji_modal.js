...
function loadEmojis(form) {
	if (emojis == 1)
	{
		...
		xhr.onload = function() {
			...
			if (cringetopia)
				emojis['cringetopia'] = ['19dollarfortnitecard','ahawow','ahayeah','alex','amogus','anarchy','angry','angryman','awaakesoyjack','backseatmodding','based','bassproshop','bert','blackpill','blingbob','blingbobhd','bluepill','booba','boof','boohoo','britishmoment','brownnose','bruh','bruhsmoke','byelol','canihavemod','cereal','cerkies','chad','chaddiscordmoderator','chadstare','cheeks','cheers','chungus','clueless','cocka','cokeza','comeagain','coom','cope','coping','cryaboutit','cryrage','cum','cummies','dab','dayum','death','delight','disbelief','disgostang','disgust','doritoberk','downisrael','downwert','drbob','face','factsandlogic','fatcryrage','fear','fedora','fjalsunna','furrymurder','getajob','gigachad','gigajammin','goingcrazy','gold','gone','goonpog','goteem','grabhand','hahawyd','heart','hehehe','hesapeonyouknow','hot','iloveyou','ipgrabber','irantroll','itsoverseal','jewbob','joebiden','kill','kissin','laughing','lean','leftgun','letsfuckinggooooooooooo','like','littledrummerboy','lolrage','love','malding','maldinggif','march','me_lon','mf','mhm','mhmdoubt','mlady','murder','nefariousacts','newport','newport~1','nibburger_king','nooo','noooo','noperms','ohwow','orange','pain','pepecringe','pepecringe2','peperagecry','phillip','pitchfork','pouroneout40','praiseallah','prayge','psycho','quagmirelet','ratio','really','redditnation','redpill','redwojack','regice','ricardosmile','sad','sadcat','sadge','sadtroll','scare','schizothread','secretside','shh','shocked','sigma','sigmamale','skill_issue','slime','slow','smoketime','sniff','splendid','squidwardno','stare','stare1','stfu','stoppedwert','stopwert','susamogus','suscoin','susge','tacobell','tempest','thanoslol','thistbh','thonk','tiresome','tm06','troll','trollcrazy','trollcrazyfurry','trollcrazypoint','trollcrazyrussia','trollcrazyukraine','trolldisappointed','trollinsane','trollsus','truetrue','turbobrainlet','twetwe','upiran','upwert','virgin','waaaah','wallstreet','wertegg','wertpinion','what','whatdeath','whensus','wholesome','womanmoment','woohoo','wtff','yeeeees','yes','yeshoney','zombie_phillip']
