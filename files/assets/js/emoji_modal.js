...
const EMOJIS_STRINGS = [
	{
		...
		emojis: {
			...
			marseymexican: 'latina latino hispanic fiesta sombrero latinx hombre mexico',
			...
			marseyspooky: 'art horror halloween holiday evil scary monster lovecraftian eldritch',
