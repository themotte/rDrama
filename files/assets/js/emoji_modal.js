...
const EMOJIS_STRINGS = [
	{
		...
		emojis: {
			...
			marseyski: '',
			marseychristmasbulb2: '',
			marseychristmaself2: '',
			marseychristmasgift: '',
			marseychristmaslove: '',
			marseychristmasparty: '',
			marseychristmasscarf: '',
			marseydiehard: 'die hard christmas terrorist gun bruce willis',
			...
			marseyoctopus2: '',
			marseyoctopus3: 'consume product epic win communities no bait too obvious globe',
