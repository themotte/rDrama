...
(function () {
    ...
    // (55:6) {#each awards as award, index}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:6) {#each awards as award, index}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 69, 8, 1884);
    			add_location(strong, file, 71, 9, 2016);
    			add_location(br, file, 71, 51, 2058);
    			attr_dev(span, "class", "text-muted");
    			add_location(span, file, 72, 9, 2075);
    			set_style(div0, "margin-left", "15px");
    			add_location(div0, file, 70, 8, 1973);
    			attr_dev(div1, "class", "award-desc p-3 svelte-13ovg7j");
    			add_location(div1, file, 68, 7, 1846);
    			attr_dev(label, "for", "note");
    			attr_dev(label, "class", "pt-4");
    			add_location(label, file, 75, 7, 2172);
    			...
    			add_location(textarea, file, 76, 7, 2236);
    			add_location(div2, file, 67, 6, 1832);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 89, 4, 2768);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 85, 5, 2631);
    			attr_dev(button, "class", "btn btn-warning");
    			attr_dev(button, "type", "button");
    			button.disabled = true;
    			add_location(button, file, 84, 4, 2569);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
