...
function updatebgselection(){
	...
	const backgrounds = [
		...
		for (i=0; i < bgsToDisplay.length; i++) {
			...
			str += `<button class="btn btn-secondary m-1 p-0" style="width:15rem; overflow: hidden;"><img style="padding:0.25rem; width: 15rem" src="/assets/CHRISTMAS/images/backgrounds/${bgsDir}/${bgsToDisplay[i]}" alt="${bgsToDisplay[i]}-background" onclick="post('/settings/profile?background=${onclickPost}')"></button>`;
		}
